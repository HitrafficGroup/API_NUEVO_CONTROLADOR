...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyUDP_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 17, 11)
    ...
    "MyUDP\0readyRead\0\0readPending"
};
...
const QMetaObject MyUDP::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyUDP.data,
      qt_meta_data_MyUDP,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyUDP.stringdata))
